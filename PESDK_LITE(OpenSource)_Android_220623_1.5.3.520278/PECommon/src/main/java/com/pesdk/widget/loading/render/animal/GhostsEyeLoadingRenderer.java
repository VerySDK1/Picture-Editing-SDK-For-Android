...
public class GhostsEyeLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mWidth = CoreUtils.dip2px(context, DEFAULT_WIDTH);
        mHeight = CoreUtils.dip2px(context, DEFAULT_HEIGHT);
        mEyeEdgeWidth = CoreUtils.dip2px(context, DEFAULT_EYE_EDGE_WIDTH);

        mEyeInterval = CoreUtils.dip2px(context, DEFAULT_EYE_CIRCLE_INTERVAL);
        mEyeBallOffsetY = CoreUtils.dip2px(context, DEFAULT_EYE_BALL_OFFSET_Y);
        mEyeCircleRadius = CoreUtils.dip2px(context, DEFAULT_EYE_CIRCLE_RADIUS);
        mMaxEyeJumptDistance = CoreUtils.dip2px(context, DEFAULT_MAX_EYE_JUMP_DISTANCE);
        mAboveRadianEyeOffsetX = CoreUtils.dip2px(context, DEFAULT_ABOVE_RADIAN_EYE_CIRCLE_OFFSET);

        mEyeBallWidth = CoreUtils.dip2px(context, DEFAULT_EYE_BALL_WIDTH);
        mEyeBallHeight = CoreUtils.dip2px(context, DEFAULT_EYE_BALL_HEIGHT);
