...
public class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mTextSize = CoreUtils.dip2px(context, DEFAULT_TEXT_SIZE);
        mStrokeWidth = CoreUtils.dip2px(context, DEFAULT_STROKE_WIDTH);
        mCenterRadius = CoreUtils.dip2px(context, DEFAULT_CENTER_RADIUS);
        mProgressCenterRadius = CoreUtils.dip2px(context, DEFAULT_PROGRESS_CENTER_RADIUS);
        ...
        mLeafDrawable = context.getResources().getDrawable(R.drawable.common_ic_loading_leaf);
        mLoadingDrawable = context.getResources().getDrawable(R.drawable.common_ic_loading);
        mElectricFanDrawable = context.getResources().getDrawable(R.drawable.common_ic_loading_eletric_fan);
