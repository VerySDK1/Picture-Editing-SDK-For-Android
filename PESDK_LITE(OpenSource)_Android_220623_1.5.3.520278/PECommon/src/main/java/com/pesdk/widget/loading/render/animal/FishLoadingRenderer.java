...
public class FishLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mRiverBankWidth = CoreUtils.dip2px(context, DEFAULT_RIVER_BANK_WIDTH);

        mPathFullLineSize = CoreUtils.dip2px(context, DEFAULT_PATH_FULL_LINE_SIZE);
        mPathDottedLineSize = CoreUtils.dip2px(context, DEFAULT_PATH_DOTTED_LINE_SIZE);
        mFishWidth = CoreUtils.dip2px(context, DEFAULT_FISH_WIDTH);
        mFishHeight = CoreUtils.dip2px(context, DEFAULT_FISH_HEIGHT);
        mFishEyeSize = CoreUtils.dip2px(context, DEFAULT_FISH_EYE_SIZE);
        mRiverWidth = CoreUtils.dip2px(context, DEFAULT_RIVER_WIDTH);
        mRiverHeight = CoreUtils.dip2px(context, DEFAULT_RIVER_HEIGHT);
