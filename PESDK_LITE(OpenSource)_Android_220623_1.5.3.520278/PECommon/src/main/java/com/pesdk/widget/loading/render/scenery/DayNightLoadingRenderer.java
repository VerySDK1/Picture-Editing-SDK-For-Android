...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mStarRadius = CoreUtils.dip2px(context, DEFAULT_STAR_RADIUS);
        mSun$MoonRadius = CoreUtils.dip2px(context, DEFAULT_SUN$MOON_RADIUS);
        ...
        mSunRayStartCoordinateY = mInitSun$MoonCoordinateY - mMaxSun$MoonRiseDistance //the center
                ...
                - CoreUtils.dip2px(context, DEFAULT_SUN_RAY_OFFSET); //sub the interval between the sun and the sun ray

        //add strokeWidth * 2.0f because the stroke cap is Paint.Cap.ROUND
        mSunRayEndCoordinateY = mSunRayStartCoordinateY - CoreUtils.dip2px(context, DEFAULT_SUN_RAY_LENGTH)
                + mStrokeWidth;
